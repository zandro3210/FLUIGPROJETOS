$(document).ready(function(){
	...
	$("#cdUnidadeResponsavel" ).change(function() {
		CustomForm.getUnitData();
	});
	...
	$( "#nrCnpj" ).change(function() {
		...
		var param = {};
		param.url = 'https://www.receitaws.com.br/v1/cnpj/' + this.value.replaceAll(".","").replaceAll("/","").replaceAll("-","");
		param.method = 'GET';
		param.success =  function(data){
			console.log(data);
			$("#razaoSocial").val(data.nome);
			$("#nmFantasia").val(data.fantasia);
