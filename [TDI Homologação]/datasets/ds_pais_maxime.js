...
//	var pacote = "_161._93._16._172._7032";
	...
	var filter = servico.instantiate(pacote + ".STRUPARAMLISTAPAIS");
	...
	log.info("DS_PAIS:" + campo + " = '" + valor + "'");
	
	try {
		var retorno = ws.listapais(filter);
		var arr = retorno.getSTRURETLISTAPAIS();

		for (var i=0;i<arr.size();i++) {
			var p = arr.get(i);
			newDataset.addRow(new Array(p.getYACODGI(), 
										p.getYADESCR(),
										p.getYASIGLA()));
		}
	}catch(e){   
