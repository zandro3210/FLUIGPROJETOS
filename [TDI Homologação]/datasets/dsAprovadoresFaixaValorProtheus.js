	...
	try{
		...
		if (fields) {
			...
			if (fields[0] != null){
				...
				log.info (	"DATASET dsAprovadoresFaixaValorProtheus - DADOS FIELDS: " +
							"cdEmpresa: " + cdEmpresa +
							"cdFilial: " + cdFilial +
							"cdCcusto: " + cdCcusto +
			...
			log.info (	"DATASET dsAprovadoresFaixaValorProtheus - DADOS CONSTRAINTS: " +
					"cdEmpresa: " + cdEmpresa +
					"cdFilial: " + cdFilial +
					"cdCcusto: " + cdCcusto +
					"cdItemCtbl: " + cdItemCtbl +
...
//		var cdCcusto = "102500300";
//		var cdCcusto = "102500300";
//		var cdItemCtbl = "0005";
//		var cdValor = "180500";
//		var emailSolic = "marco.cafasso@totvs.com.br";
