...
newDataset.addRow(new Array("1",1,"VIEW_APR","1"));
newDataset.addRow(new Array("1",1,"VIEW_PF9","1"));
newDataset.addRow(new Array("1",2,"VIEW_APR","1"));
newDataset.addRow(new Array("1",2,"VIEW_PF9","1"));
